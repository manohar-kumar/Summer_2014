...
class GroupUI extends JFrame{
	...
	public GroupUI(String Name) {
        ...
        //				
			...
			friends=new Final(Paths.get("test"),true).my_friends();
			String line;
			...
			create.addActionListener(new ActionListener(){
					...
					bw.write("\r\n");
					bw.close();*/
					String my_name=new Final(Paths.get("test"),true).myname;
					new Final(Paths.get("test"),true).create_group(groupName,my_name);
			...
			groups=new Final(Paths.get("test"),true).my_groups();
			String line2;
...
public class UI extends JFrame{
	...
	public UI() {
		...
		JTextField Browse=new JTextField(20);
			ActivityInfo.add(BrowseFriend);
			ActivityInfo.add(AddFriend);
			ActivityInfo.add(select);
			ActivityInfo.add(Browse);
			ActivityInfo.add(OK);
		select.addActionListener(new ActionListener(){
			...
			copyFolder(Paths.get(path),Paths.get("F:\\NewFolder\\ganga\\" + nameoffile));
			}
			}
				catch(Exception e){}	
					}
			...
			AddFriend.addActionListener(new ActionListener(){
					...
					new Final(Paths.get("test"),true).make_friend(friendName);
...
String sCurrent;
    ...
    public static void main(String[] args) {
      ...
      SwingUtilities.invokeLater(new Runnable() {
		...
		new Final(Paths.get("test"),true).processEvents(Paths.get("dir"));
	}
	 catch (IOException x) {
